...
def queue_annotate_sv_jobs(
    ...
    input_dict: dict = {
        ...
        'sv_per_shard': 5000,
        'external_af_population': config.config_retrieve(['annotate', 'external_af_population']),
        'external_af_ref_prefix': config.config_retrieve(['annotate', 'external_af_ref_bed_prefix']),
        'external_af_ref_bed': config.config_retrieve(['references', 'gnomad_sv']),
        'use_hail': False,
        'noncoding_bed': config.config_retrieve(['annotate', 'noncoding_bed']),
        'protein_coding_gtf': config.config_retrieve(['annotate', 'protein_coding_gtf']),
